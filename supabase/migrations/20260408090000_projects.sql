...
drop policy if exists "Activity visible via accessible task" on public.task_activity;
...
drop policy if exists "Links visible via accessible task" on public.task_links;
